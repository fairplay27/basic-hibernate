package it.secservizi.CD.util.sample.hibernate.hbm.maven.basic;

import java.util.Date;

import org.hibernate.Session;

import it.secservizi.CD.util.sample.hibernate.hbm.maven.basic.user.DBUser;
import it.secservizi.CD.util.sample.hibernate.hbm.maven.basic.util.HibernateUtil;
